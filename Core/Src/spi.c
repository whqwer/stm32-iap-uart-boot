...
#include "spi.h"
/* USER CODE BEGIN 0 */
#include "spi_func.h"   /* LCD_DC_Set() for HAL_SPI_TxCpltCallback */
/* USER CODE END 0 */
...
/* USER CODE BEGIN 1 */
/**
  * @brief SPI TX DMA complete callback — mirrors app behaviour.
  *        Sets DC high so the line is in data-mode between transfers.
  */
